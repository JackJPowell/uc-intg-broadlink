...
class BroadlinkRemote(Remote):
    ...
    async def handle_command(
        ...
        match cmd_id:
            case Commands.ON:
                return await self._device.send_command(Commands.ON)
        ...
        if cmd_id == Commands.SEND_CMD:
            ...
            for _ in range(0, repeat):
                match action.upper():
                    ...
                    case _:
                        await self._device.send_command(command_or_status)
            return StatusCodes.OK
            ...
            for command in params.get("sequence", []):
                for _ in range(0, repeat):
                    ...
                    if isinstance(command_or_status, StatusCodes):
                        ...
                        res = await self._device.send_command(command_or_status)
